...
function Minicart() {
  ...
  const cartActiveClasses = () => {
    return isDropdownShow
      ? "py-2 pl-2 pr-7 md:pl-4 md:pr-11 bg-white text-primary-500"
      : "py-2 pl-2 pr-7 md:pl-4 md:pr-11";
  };
    ...
    <div className="md:relative">
      <div className="relative">
        <button onClick={handleCartToggle} className={cartActiveClasses()}>
          ...
          <span className="hidden md:inline-block md:align-middle">Cart</span>
        </button>
        <div
          className={`absolute left-9 top-[10px] h-6 w-6  overflow-hidden rounded-2xl border border-gray-400 px-[2px] text-center text-xs font-bold leading-6 md:left-[92px] ${
            isDropdownShow
